...
if __name__ == "__main__":
    ...
    query_image_list = "data/tandt/train/results_sparse.txt"
    with open(query_image_list, "r") as f:
        for data in f.read().rstrip().split("\n"):
            ...
            base_image_folder = "/root/autodl-tmp/Hierarchical-Localization/datasets/tandt/train"
            ...
            ##### 重点关注第一个参数
            cam_intrinsic_first = 1159.5880733
            cam_intrinsic_second = 1164.66012875
            ...
            while OPEN:
                ...
                for pos_item, value_item in [(0, 1e-3), (0, -1e-3), (1, 1e-3), (1, -1e-3), (2, 1e-3), (2, -1e-3), (3, 1e-3), (3, -1e-3),
                                             (4, 1e-3), (4, -1e-3), (5, 1e-3), (5, -1e-3), (6, 1e-3), (6, -1e-3)
            ...
            # 打开文件以追加方式写入
            with open('data/tandt/train/results_refine.txt', 'a') as f:
