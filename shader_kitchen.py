...
def judge_dist_and_deg(q1, t1, q2, t2):
    ...
    is_less_than_m = e_t <= 0.05     ##########  根据定位评估结果确定
...
if __name__ == "__main__":
    ...
    query_image_list = "/root/autodl-tmp/comment_3DGS/data/12scenes/office1/lounge/results_sparse.txt"
    with open(query_image_list, "r") as f:
        for data in f.read().rstrip().split("\n"):
            ...
            base_image_folder = "/root/autodl-tmp/Hierarchical-Localization/datasets/12scenes/office1/lounge"
            ...
            ##### 重点关注第一个参数，可以考虑使用trianglation里的参数值
            cam_intrinsic_first = 1158.3
            cam_intrinsic_second = 1153.53
            ...
            # 打开文件以追加方式写入
            with open('/root/autodl-tmp/comment_3DGS/data/12scenes/office1/lounge/results_refine.txt', 'a') as f:
